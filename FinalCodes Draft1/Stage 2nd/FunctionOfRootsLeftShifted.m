function out = FunctionOfRootsLeftShifted
...
for i = 1:simulations
    if i == 1
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r3').set('size', {'W + epsilon8[mm]' 'length_of_first + epsilon9[mm]'});
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r4').set('size', {'W' 'height_of_2microstrip_p2'});
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r9').set('size', {'W + epsilon16[mm] + epsilon20[mm]' 'height_of_4microstrip_p1 + epsilon21[mm]'});
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r10').set('size', {'W + epsilon17[mm] + epsilon20[mm]' 'height_of_4microstrip_p2'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r10').set('base', 'center');
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r10').set('pos', {'-s_width/2 + W1 + 0.765[mm] - W/2 + gap_1 + gap_2 +gap_3+ 3*W' '0'});
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r11').set('size', {'W + epsilon17[mm] + epsilon19[mm]' 'L - height_of_4microstrip_p1 - height_of_4microstrip_p2 + epsilon18[mm]'});
        ...
        writematrix('This is First root Left Shift','LeftShift.txt','Delimiter','tab')
        ...
        for j = 1:length(S11_sinks)
            ...
            writematrix(S11_frequence,'LeftShift.txt','WriteMode','append')
            writematrix(S11_dB,'LeftShift.txt','WriteMode','append')
            writematrix('             ','LeftShift.txt','WriteMode','append')
        ...
        for k = 1:length(S11_local_max)
            ...
            writematrix(S11_local_max_dB,'LeftShift.txt','WriteMode','append')
            writematrix('             ','LeftShift.txt','WriteMode','append')
        end
    ...
    elseif i == 2
        ...
        % Increasment of width of the Third Microstrip Part 2:
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r7').set('size', {'W' 'heigth_of_3microstrip_p2'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r7').set('base', 'center');
        ...
        % Increasment of width of the Fourth Microstrip Part 2:
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r10').set('size', {'W' 'height_of_4microstrip_p2'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r10').set('base', 'center');
        ...
        % Increasment of width of the Fifth Microstrip Part 1:
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').set('size', {'W + epsilon22[mm]' 'height_of_5microstrip_p1 + epsilon27[mm]'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').set('base', 'center');
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r14').set('size', {'W + epsilon23[mm] + epsilon25[mm]' 'L - height_of_5microstrip_p1 - height_of_5microstrip_p2 + epsilon24[mm]'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r14').set('base', 'center');
        ...
        % Open a text file to store the desirable data:
        writematrix('This is Second root Left Shift','LeftShift.txt','WriteMode','append')
    ...
    elseif i == 3
        ...
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r5').set('size', {'W - epsilon5[mm] - epsilon7[mm]' 'L - length_of_first - height_of_2microstrip_p2 + epsilon6[mm]'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r5').set('base', 'center');
        ...
        % Increasment of width of the Fifth Microstrip Part 1:
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').set('size', {'W + epsilon22[mm] + epsilon26[mm]' 'height_of_5microstrip_p1 + epsilon27[mm]'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').set('base', 'center');
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').set('pos', {'-s_width/2 + W1 + 0.765[mm] - W/2 + gap_1 + 2*gap_2 +gap_3+ 4*W' '0'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r12').setIndex('pos', ['-s_length/2 + length_of_first/2 + L1 +height_of_2microstrip_p2/2 +' ...
            '3* L/2 +heigth_of_3microstrip_p2/2  + height_of_4microstrip_p2/2 - shift27[mm]'], 1);
        ...
        % Increasment of width of the Fifth Microstrip Part 2:
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r13').set('size', {'W + epsilon23[mm] + epsilon26[mm]' 'height_of_5microstrip_p2'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r13').set('base', 'center');
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r13').set('pos', {'-s_width/2 + W1 + 0.765[mm] - W/2 + gap_1 + 2*gap_2 +gap_3+ 4*W' '0'});
        model.component('comp1').geom('geom1').feature('wp1').geom.feature('r13').setIndex('pos', ['-s_length/2 + length_of_first/2 + L1 +height_of_2microstrip_p2/2 +' ...
            '3* L/2 +heigth_of_3microstrip_p2/2  + height_of_4microstrip_p2/2 + height_of_5microstrip_p2/2 + height_of_5microstrip_p1/2'], 1);
        ...
        % Open a text file to store the desirable data:
        writematrix('This is Third root Left Shift','LeftShift.txt','WriteMode','append')
    ...
    elseif i == 4
        ...
        % Open a text file to store the desirable data:
        writematrix('This is Fourth root Left Shift','LeftShift.txt','WriteMode','append')
...
out = FunctionOfRootsLeftShifted;
