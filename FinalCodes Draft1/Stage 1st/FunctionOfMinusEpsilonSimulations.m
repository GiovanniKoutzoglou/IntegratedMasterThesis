function out = FunctionOfMinusEpsilonSimulations
...
for i = 1:simulations
    ...
    if i == 1
        ...
        % Define the decreasement on the width of the first microstrip:
        ...
        writematrix('This is -Epsilon1 Simulation','minus text file.txt','Delimiter','tab')
        ...
        for j = 1:length(S11_sinks)
            ...
            writematrix(S11_frequence,'minus text file.txt','WriteMode','append')
            writematrix(S11_dB,'minus text file.txt','WriteMode','append')
            writematrix('             ','minus text file.txt','WriteMode','append')
        ...
        for k = 1:length(S11_local_max) 
            ...
            writematrix(S11_local_max_dB,'minus text file.txt','WriteMode','append')
            writematrix('             ','minus text file.txt','WriteMode','append')
        end
    ...
    elseif i == 2
        ...
        % Define the decreasement on the length of the first microstrip:
        ...
        % Decreasement of length of the First Microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon2 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 3
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon3 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 4
        ...
        % Define the decreasement on the width of the second microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon4 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 5
        ...
        % Decreasement of width of the Second Microstrip Part 3:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon5 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 6
        ...
        % Define the decreasement on the length of the second microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon6 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 7
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon7 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 8
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon8 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 9
        ...
        % Decreasement of length of the Second Microstrip Part 1:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon9 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 10
        ...
        % Define the decreasement on the width of the third microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon10 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 11
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon11 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 12
        ...
        % Define the decreasement on the length of the third microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon12 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 13
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon13 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 14
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon14 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 15
        ...
        % Decreasement of length of the Third Microstrip Part 1:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon15 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 16
        ...
        % Define the decreasement on the width of the fourth microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon16 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 17
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon17 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 18
        ...
        % Define the decreasement on the length of the fourth microstrip:
       ...
       % Save the data from the graph of S11:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon18 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 19
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon19 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 20
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon20 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 21
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon21 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 22
        ...
        % Define the decreasement on the width of the fifth microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon22 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 23
        ...
        % Decreasement of width of the Fifth Microstrip Part 3:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon23 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 24
        ...
        % Define the decreasement on the length of the fifth microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon24 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 25
       ...
       % Save the data from the graph of S11:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon25 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 26
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon26 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 27
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon27 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 28
        ...
        % Define the decreasement on the width of the sixth microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon28 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 29
        ...
        % Define the decreasement on the length of the sixth microstrip:
        ...
        % Decreasement of length of the Sixth Microstrip:
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon29 Simulation','minus text file.txt','WriteMode','append')
    ...
    elseif i == 30
        ...
        % Open a text file to store the desirable data:
        writematrix('This is -Epsilon30 Simulation','minus text file.txt','WriteMode','append')
...
out = FunctionOfMinusEpsilonSimulations;
